    ...
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content " id="modall">
        <div class="modal-header text-start">
            <h5 class="modal-title title1 text-secondary" id="exampleModalLabel">Creating a Discussion...</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <select name="title" class="form-select" style="background-color: orange" wire:model.defer="title">
...
<div wire:ignore.self class="modal fade" id="click-delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title title3 text-dark"  id="exampleModalLabel">Are you sure you want to delete this discussion?</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
        </div>
...
<div wire:ignore.self class="modal fade" id="click-edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content" id="modall">
        <div class="modal-header">
            <h5 class="modal-title title2 text-dark" id="exampleModalLabel">Editing the discussion...</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
        </div>
        ...
        <div class="modal-footer">
            <button type="button" id="submit-button" class="btn btn-success form-control" wire:click="updatePosts()">Update Discussion</button>
        </div>
        </div>
    </div>
</div>
