<div class="div">
    ...
    <div class="container ">
        ...
        <div class="post-body">
            <div class="col-md-6" style="width: 560px">
                <div class=" shadow-md p-3 " id="write">
                    <button class="write-2 form-control" style="color:white;background-color: #0c86d8;" data-toggle="modal" data-target="#click">+ Create new discussion</button>
                </div>
            </div>
            ...
            <div class="col-md-10  offset-2">
                ...
                <div class="card shadow-md mt-3 {{ $post->user->gender === 'Female' ? 'f1' : 'm1' }}"  style="width: 900px">
                    ...
                    <div class="card-footer">
                        ...
                        src="{{ $post->user->gender === 'Male' ? asset('images/anime boy.jfif') : asset('images/anime girl.jfif') }}"
                        alt="photo">
        ...
        @if($posts->isEmpty())
            <div style="color: rgb(145, 27, 27)">
                <h1 class="text-center mt-4" style="font-size: 30px;">No Discussion.</h1>
            </div>
        @endif
