<div class="container col-md-12 ">
    ...
    <div class="profile">
        <h2 class="mt-3 text-black" style="font-weight: 400; font-size: 30px; color: rgb(255, 184, 53)"><span style="font-weight: 400; font-size: 30px; color: rgb(255, 184, 53)">Recent Anime Discussion</span></h2>
    </div>
    <div class="post-body">
        ...
        <div class="col-md-4">
            ...
            @endif
            <select class="form-select mb-1" style="background-color: orange;" wire:model.lazy="title">
            ...
            <div class="card mt-3 {{ $recent->user->gender === 'Female' ? 'f1' : 'm1' }}" style="width: 900px">
                ...
                <div class="card-footer">
                    ...
                    src="{{ $recent->user->gender === 'Male' ? asset('images/anime boy.jfif') : asset('images/anime girl.jfif') }}"
                    alt="photo">
    ...
    @if($recents->isEmpty())
        <div style="color:  rgb(180, 37, 37)">
            <h1 class="text-center" style="font-size: 30px;">No Discussion.</h1>
        </div>
    @endif
